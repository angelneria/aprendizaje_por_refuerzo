...
if __name__ == '__main__':  
    ...
    print("Aplicando Q-learning al mapa grande con factor de descuento 0,9 y 200000 iteraciones")
    ...
    print("Aplicando Q-learning al mapa grande con factor de descuento 0,87 y 200000 iteraciones")
    nav_transiciones_sistema = crea_transiciones_sistema(0.2, nav_estados, mapa_grande)
    nav_recompensas_sistema = crea_recompensas_sistema(nav_estados, nav_acciones, destino_grande, mapa_grande, 1000, 100)
    aplica_Qlearning(0.87,nav_transiciones_sistema, nav_recompensas_sistema, nav_acciones, nav_estados, mapa_grande, destino_grande, 200000)
    ...
    print("Aplicando Q-learning al mapa mediano con factor de descuento 0,9 y 200000 iteraciones")
    ...
    print("Aplicando Q-learning al mapa mediano con factor de descuento 0,87 y 200000 iteraciones")
    nav_transiciones_sistema2 = crea_transiciones_sistema(0.2, nav_estados2, mapa_mediano)
    nav_recompensas_sistema2 = crea_recompensas_sistema(nav_estados2, nav_acciones, destino_mediano, mapa_mediano, 1000, 100)
    aplica_Qlearning(0.87,nav_transiciones_sistema2, nav_recompensas_sistema2, nav_acciones, nav_estados2, mapa_mediano, destino_mediano, 200000)
    ...
    print("Aplicando Q-learning al mapa pequeño con factor de descuento 0,9 y 200000 iteraciones")
    ...
    print("Aplicando Q-learning al mapa pequeño con factor de descuento 0,87 y 200000 iteraciones")
    nav_transiciones_sistema3 = crea_transiciones_sistema(0.2, nav_estados3, mapa_pequeño)
    nav_recompensas_sistema3 = crea_recompensas_sistema(nav_estados3, nav_acciones, destino_pequeño, mapa_pequeño, 1000, 100)
    aplica_Qlearning(0.87,nav_transiciones_sistema3, nav_recompensas_sistema3, nav_acciones, nav_estados3, mapa_pequeño, destino_pequeño, 200000)
